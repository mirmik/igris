...
namespace std
{
	...
	private:
		...
		static bool test(
		    ...
		    sizeof( C_T ) ==
		    sizeof( C_T(
		                static_cast< C_AT_1 >( *static_cast< typename std::remove_reference< C_AT_1 >::type* >( NULL ) ),
		                static_cast< C_AT_2 >( *static_cast< typename std::remove_reference< C_AT_2 >::type* >( NULL ) ),
		                static_cast< C_AT_3 >( *static_cast< typename std::remove_reference< C_AT_3 >::type* >( NULL ) ),
		                static_cast< C_AT_4 >( *static_cast< typename std::remove_reference< C_AT_4 >::type* >( NULL ) )
		            ) )
		    >::type*
		);
	...
	private:
		...
		template< typename C_T >
		static bool test( typename std::enable_if< sizeof( C_T ) == sizeof( testFun( C_T() ) ) >::type* );
