...
static inline int bit_ctz(unsigned long x)
{
    ...
    sh = !(x & __bit_lsb_mask(1 << 4)) << 4;
    nr += sh;
    x >>= sh;
    sh = !(x & __bit_lsb_mask(1 << 3)) << 3;
    nr += sh;
    x >>= sh;
    sh = !(x & __bit_lsb_mask(1 << 2)) << 2;
    nr += sh;
    x >>= sh;
    sh = !(x & __bit_lsb_mask(1 << 1)) << 1;
    nr += sh;
    x >>= sh;
    sh = !(x & __bit_lsb_mask(1 << 0)) << 0;
    nr += sh;
...
static inline int bit_clz(unsigned long x)
{
    ...
    sh = !(x & __bit_msb_mask(1 << 4)) << 4;
    nr += sh;
    x <<= sh;
    sh = !(x & __bit_msb_mask(1 << 3)) << 3;
    nr += sh;
    x <<= sh;
    sh = !(x & __bit_msb_mask(1 << 2)) << 2;
    nr += sh;
    x <<= sh;
    sh = !(x & __bit_msb_mask(1 << 1)) << 1;
    nr += sh;
    x <<= sh;
    sh = !(x & __bit_msb_mask(1 << 0)) << 0;
    nr += sh;
