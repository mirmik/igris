...
uint8_t igris::crc8_table(const uint8_t *addr, uint8_t len, uint8_t crc_init)
{
...
//
uint8_t igris::crc8(const void *data, uint8_t len, uint8_t crc_init)
{
...
uint16_t igris::crc16(const void *data, uint16_t length, uint16_t crc_init)
{
...
uint8_t igris::mmc_crc7(const uint8_t *message, const uint8_t length)
{
...
uint32_t igris::crc32(const void *data, uint32_t length, uint32_t crc_init)
{
