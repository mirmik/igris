...
#define SETTER(name, param)                                                    \
    void name(decltype(param) value) { param = value; }
...
#define VALUE_GETTER(name, param)                                              \
    auto name() const->decltype(param) { return param; }

#define REFERENCE_GETTER(name, param)                                          \
    auto name()->decltype(param) & { return param; }

#define CONSTREF_GETTER(name, param)                                           \
    auto name() const->decltype(param) const & { return param; }
